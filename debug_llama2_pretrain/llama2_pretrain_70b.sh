...
#SBATCH --error=/lustre/fsw/joc/guyueh/llama2_a100_perf/nemo_jason_mcore_llama/debug_llama2_pretrain/llama2_70b/log-joc-llama2:70b_pretrain_profile_%j.err
#SBATCH --exclusive
#SBATCH --job-name=joc-llama2:70b_pretrain_profile
#SBATCH --mem=0
#SBATCH --nodes=8
#SBATCH --ntasks-per-node=8
#SBATCH --output=/lustre/fsw/joc/guyueh/llama2_a100_perf/nemo_jason_mcore_llama/debug_llama2_pretrain/llama2_70b/log-joc-llama2:70b_pretrain_profile_%j.err
...
# command 1
srun --output /lustre/fsw/joc/guyueh/llama2_a100_perf/nemo_jason_mcore_llama/debug_llama2_pretrain/llama2_70b/log-joc-llama2:70b_pretrain_profile_%j.err --error /lustre/fsw/joc/guyueh/llama2_a100_perf/nemo_jason_mcore_llama/debug_llama2_pretrain/llama2_70b/log-joc-llama2:70b_pretrain_profile_%j.err --container-image ${CONTAINER_IMAGE} --container-mounts "/lustre/fsw/joc/guyueh/llama2_a100_perf:/lustre/fsw/joc/guyueh/llama2_a100_perf,/lustre/fsw/joc/guyueh/data:/lustre/fsw/joc/guyueh/data,/lustre/fsw/joc/big_nlp/nemo_gpt3:/lustre/fsw/joc/big_nlp/nemo_gpt3,/lustre/fsw/joc/big_nlp/nemo_ci_resources:/lustre/fsw/joc/big_nlp/nemo_ci_resources" --no-container-mount-home bash -c "
