...
#SBATCH --error=/lustre/fsw/joc/guyueh/llama2_a100_perf/nemo_jason_mcore_llama/debug_llama2_pretrain/llama2_13b/log-coreai_dlalgo_llm-llama2:13b_pretrain_profile_%j.err
#SBATCH --exclusive
#SBATCH --job-name=coreai_dlalgo_llm-llama2:13b_pretrain_profile
#SBATCH --mem=0
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=8
#SBATCH --output=/lustre/fsw/joc/guyueh/llama2_a100_perf/nemo_jason_mcore_llama/debug_llama2_pretrain/llama2_13b/log-coreai_dlalgo_llm-llama2:13b_pretrain_profile_%j.err
