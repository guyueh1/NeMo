...
#SBATCH --error=/home/guyueh/llama2_l40s_profile/guyueh1_nemo/debug_llama2_pretrain/l40s_scripts/srun_logs/log-llama2_7b:debug_%j.err
#SBATCH --exclusive
#SBATCH --job-name=llama2_7b:debug
#SBATCH --mem=0
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=8
#SBATCH --output=/home/guyueh/llama2_l40s_profile/guyueh1_nemo/debug_llama2_pretrain/l40s_scripts/srun_logs/log-llama2_7b:debug_%j.err
...
# command 1
srun --output /home/guyueh/llama2_l40s_profile/guyueh1_nemo/debug_llama2_pretrain/l40s_scripts/srun_logs/log-llama2_7b:debug_%j.err --error /home/guyueh/llama2_l40s_profile/guyueh1_nemo/debug_llama2_pretrain/l40s_scripts/srun_logs/log-llama2_7b:debug_%j.err --container-image ${CONTAINER_IMAGE} --container-mounts "/home/guyueh/llama2_l40s_profile:/home/guyueh/llama2_l40s_profile" bash -c "
