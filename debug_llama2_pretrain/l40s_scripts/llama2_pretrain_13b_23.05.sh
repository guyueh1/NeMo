...
#SBATCH --error=/home/guyueh/llama2_l40s_profile/guyueh1_nemo/debug_llama2_pretrain/l40s_scripts/srun_logs/log-llama2_13b:debug_%j.err
#SBATCH --exclusive
#SBATCH --job-name=llama2_13b:debug
#SBATCH --mem=0
#SBATCH --nodes=2
#SBATCH --ntasks-per-node=8
#SBATCH --output=/home/guyueh/llama2_l40s_profile/guyueh1_nemo/debug_llama2_pretrain/l40s_scripts/srun_logs/log-llama2_13b:debug_%j.err
