NEMO=/lustre/fsw/joc/guyueh/llama2_mem_bug/NeMo
MLM=/lustre/fsw/joc/guyueh/llama2_mem_bug/megatron-lm
SCRIPT_DIR=${NEMO}/examples/nlp/language_modeling/tuning
CKPT_DIR=/lustre/fsw/joc/guyueh/data/ckpt/llama2_configs/7b
...
# CUDA_VISIBLE_DEVICES=0 python ${SCRIPT_DIR}/${script_name} \
torchrun --nproc_per_node=8 ${SCRIPT_DIR}/${script_name} \
