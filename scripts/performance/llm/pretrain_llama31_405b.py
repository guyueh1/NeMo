...
def override_recipe_configs(
    ...
    if use_mcore_fsdp and gpu_type == 'gb200':
        recipe.trainer.strategy.num_distributed_optimizer_instances = (num_nodes * 4) / 64 if args.num_distributed_optimizer_instances is None else args.num_distributed_optimizer_instances
